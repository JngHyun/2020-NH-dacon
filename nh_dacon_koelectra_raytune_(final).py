# -*- coding: utf-8 -*-
"""NH_dacon_KoELECTRA_raytune (final)

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1HDgqiqhJ02uAMQpoDa6xUYavJ_WFp6Tv
"""
...
model_state, optimizer_state = torch.load("./checkpoint_48_512_epoch2")
model.load_state_dict(model_state)
optimizer.load_state_dict(optimizer_state)
...
id = result_dict["id"]
with open('./submission_koelectra_small_v3_b64_256_epoch2.csv','w') as f:
